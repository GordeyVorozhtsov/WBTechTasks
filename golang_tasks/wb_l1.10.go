...
// func splitingToKey(m map[int][]float32,temperatureList []float32) {
// 	for _,elem := range temperatureList{
// 		ceil := int(math.Ceil(elem))
// 		m[]

// 	//if ceil := math.Ceil(x); m[]
// 	}
// }

// if _,exist := m[ceil];exist{
// 	m[ceil] = e
// }
